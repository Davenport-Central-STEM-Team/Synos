...
# Todo: replace all read* with the block read?
...
class Mpu9250(object):
    def __init__(self, bus=1):
        ...
        sleep(0.2)
        self.bus.write_byte_data(MPU9250_ADDRESS, PWR_MGMT_1,
                                 0x01)  # auto select clock source
        ...
        self.write(AK8963_ADDRESS, AK8963_CNTL1,
                   (AK8963_16BIT | AK8963_8HZ))  # cont mode 1
    ...
    def temp(self):
        ...
        temp = ((
                            temp_out - 21.0) / 333.87) + 21.0  # these are from the datasheets
    ...
    def mag(self):
        ...
        self.read8(AK8963_ADDRESS,
                   AK8963_ST2)  # needed step for reading magnetic data
        return data
